...
export function LandingHeader() {
  return (
    <div className="sticky top-0 z-40">
      <div className="bg-sage-800 px-6 py-2 text-center text-xs font-medium text-cream-50">
        🌿 Planly is gratis te gebruiken voor jullie gezin{" "}
        <Link href="/signup" className="font-semibold text-peach-200 hover:underline">
          Gratis starten →
        </Link>
      </div>
      <header className="border-b border-sage-200/70 bg-cream-100/85 backdrop-blur">
